...
def predict():
    ...
    rowlist=[]
    rowlist.append(age)
    rowlist.extend((admin,blue,entre,hmaid,man,ret,self,ser,stu,tech,job_un,div,mar,sin,b4y,b6y,b9y,high,illi,prof,univ,default,hous,loan_yes,cell,tele,apr,aug,dec,jul,jun,mar,may,nov,octo,sept,fri,mon,thu,tue,wed,duration,campaign,pdays,previous,fail,non,suc,varrate,price,conf,euribor))
